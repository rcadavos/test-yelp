  ...
  return (
    <>
      ...
      <main
        id="main-content"
        tabIndex={-1}
        className="flex min-h-0 flex-1 flex-col outline-none focus-visible:ring-2 focus-visible:ring-sf-accent focus-visible:ring-offset-2 focus-visible:ring-offset-sf-mint-soft max-md:min-h-0 max-md:overflow-hidden"
        role="main"
